                    ...
                    <div className="lg:w-[28rem] mx-auto my-auto flex flex-col justify-center pt-8 md:justify-start md:px-6 md:pt-0">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col pt-3 md:pt-8">
                            ...
                            <div className="mb-12 flex flex-col pt-4">
                                <div className="focus-within:border-b-gray-500 relative flex overflow-hidden border-b-2 transition">
                                    <input value={otp} onChange={(e) => setOtp(e.target.value)} type="text" disabled={!otpSent} className="w-full flex-1 appearance-none border-gray-300 bg-white px-4 py-2 text-base text-gray-700 placeholder-gray-400 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" placeholder="OTP" />
                                </div>
                            </div>
